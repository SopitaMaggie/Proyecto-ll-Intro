class Unidad:
    # Diccionario con los tipos de unidades disponibles y su info
    TIPOS = {
        "flechas": {
            "nombre": "Flechas",
            "costo": 40,
    ...
    def __init__(self, tipo):
        # pone una unidad según el tipo seleccionado con su info
        tipo = tipo.lower()
        ...
        # para saber cuando usar la habilidad
    ...
    def aplicar_veneno(self, dano_veneno=5):
        # Aplica daño por veneno si la unidad está envenenada.
        if self.envenenada > 0:
            self.vida = max(0, self.vida - dano_veneno)
            self.envenenada -= 1
    def mostrar(self):
        # Muestra en consola la información completa de la unidad.
    ...
    def _ataque_normal(self, objetivo):
        ...
        if self.tipo == "flechas":
            ...
            objetivo.recibir_dano(self.dano)
            # El ninja puede debilitar torres.
